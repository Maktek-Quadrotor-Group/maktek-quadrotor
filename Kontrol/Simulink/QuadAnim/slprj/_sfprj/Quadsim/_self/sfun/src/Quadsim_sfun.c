  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2762239538U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3338750622U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1848604050U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2073842482U);
  }
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 2:
      {
        if (strcmp(aiChksum, "5Ok8oRpFfIxWTsDpecrEBH") == 0) {
     ...
     case 4:
      {
        if (strcmp(aiChksum, "Y13Ws3ALp5PfBrFx9vErGD") == 0) {
     ...
     case 5:
      {
        if (strcmp(aiChksum, "dGflvlZRZzuo19kzpbum7E") == 0) {
...
{
  _QuadsimMachineNumber_ = sf_debug_initialize_machine("Quadsim","sfun",0,6,0,0,
    0);
