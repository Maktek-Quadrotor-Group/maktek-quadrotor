...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(327744572U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2017937075U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(811650981U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(249947600U);
}
...
mxArray *sf_c2_Quadsim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("5Ok8oRpFfIxWTsDpecrEBH");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1744);
...
static void mdlSetWorkWidths_c2_Quadsim(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3477968697U));
  ssSetChecksum1(S,(3735909469U));
  ssSetChecksum2(S,(623539412U));
  ssSetChecksum3(S,(2460768184U));
