...
static const char * c2_debug_family_names[47] = { "arm_l", "m", "Ixx", "Iyy",
  "Izz", "b", "d", "g", "Jr", "l", "a1", "a2", "a3", "a4", "a5", "b1", "b2",
  "b3", "X_dot", "Y_dot", "Z_dot", "Roll_dot", "Pitch_dot", "Yaw_dot", "X", "Y",
  "Z", "Roll", "Pitch", "Yaw", "U1", "U2", "U3", "U4", "Omega", "ux", "uy",
  "X_ddot", "Y_ddot", "Z_ddot", "Roll_ddot", "Pitch_ddot", "Yaw_ddot", "nargin",
  "nargout", "Xin", "Xout" };
...
static void sf_c2_Quadsim(SFc2_QuadsimInstanceStruct *chartInstance)
{
  ...
  real_T (*c2_Xin)[17];
  real_T (*c2_Xout)[12];
  c2_Xin = (real_T (*)[17])ssGetInputPortSignal(chartInstance->S, 0);
  c2_Xout = (real_T (*)[12])ssGetOutputPortSignal(chartInstance->S, 1);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
...
static void c2_chartstep_c2_Quadsim(SFc2_QuadsimInstanceStruct *chartInstance)
{
  ...
  real_T (*c2_b_Xout)[12];
  real_T (*c2_b_Xin)[17];
  c2_b_Xin = (real_T (*)[17])ssGetInputPortSignal(chartInstance->S, 0);
  ...
  sf_debug_symbol_scope_push_eml(0U, 47U, 47U, c2_debug_family_names,
    c2_debug_family_var_map);
  sf_debug_symbol_scope_add_eml_importable(&c2_arm_l, 0U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c2_m, 1U, c2_c_sf_marshallOut);
  ...
  sf_debug_symbol_scope_add_eml_importable(&c2_b, 5U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_d, 6U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_g, 7U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c2_Jr, 8U, c2_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_l, 9U, c2_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_a1, 10U, c2_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_a2, 11U, c2_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_a3, 12U, c2_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_a4, 13U, c2_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_a5, 14U, c2_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_b1, 15U, c2_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_b2, 16U, c2_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_b3, 17U, c2_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c2_X_dot, 18U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_Y_dot, 19U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_Z_dot, 20U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_Roll_dot, 21U,
    c2_c_sf_marshallOut, c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_Pitch_dot, 22U,
    c2_c_sf_marshallOut, c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_Yaw_dot, 23U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_X, 24U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_Y, 25U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_Z, 26U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_Roll, 27U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_Pitch, 28U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_Yaw, 29U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_U1, 30U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_U2, 31U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_U3, 32U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_U4, 33U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_Omega, 34U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_ux, 35U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_uy, 36U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_X_ddot, 37U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_Y_ddot, 38U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_Z_ddot, 39U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_Roll_ddot, 40U,
    c2_c_sf_marshallOut, c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_Pitch_ddot, 41U,
    c2_c_sf_marshallOut, c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_Yaw_ddot, 42U,
    c2_c_sf_marshallOut, c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_nargin, 43U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_nargout, 44U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(c2_Xin, 45U, c2_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(c2_Xout, 46U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c2_a1 = -0.7333333333333335;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 15);
  c2_a2 = 0.0086666666666666663;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 16);
  c2_a3 = 0.7333333333333335;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 17);
  c2_a4 = 0.0086666666666666663;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 18);
  c2_a5 = 0.0;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 19);
  c2_b1 = 30.666666666666668;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 20);
  c2_b2 = 30.666666666666668;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 21);
  c2_b3 = 17.69230769230769;
  ...
  c2_h_b = c2_ux;
  c2_g_y = 1.0526315789473684 * c2_h_b;
  c2_g_a = c2_g_y;
  c2_i_b = c2_U1;
  c2_X_ddot = c2_g_a * c2_i_b;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 75);
  c2_j_b = c2_uy;
  c2_h_y = 1.0526315789473684 * c2_j_b;
  c2_h_a = c2_h_y;
  c2_k_b = c2_U1;
  c2_Y_ddot = c2_h_a * c2_k_b;
  ...
  c2_i_a = c2_v_x;
  c2_l_b = c2_x_x;
  c2_i_y = c2_i_a * c2_l_b;
  c2_m_b = c2_i_y;
  c2_j_y = 1.0526315789473684 * c2_m_b;
  c2_j_a = c2_j_y;
  c2_n_b = c2_U1;
  c2_k_y = c2_j_a * c2_n_b;
  c2_Z_ddot = c2_g - c2_k_y;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 77);
  c2_k_a = c2_Pitch_dot;
  c2_o_b = c2_Yaw_dot;
  c2_l_y = c2_k_a * c2_o_b;
  c2_l_a = c2_l_y;
  c2_m_y = c2_l_a * -0.7333333333333335;
  c2_m_a = c2_Pitch_dot;
  c2_n_y = c2_m_a * 0.0086666666666666663;
  c2_n_a = c2_n_y;
  c2_p_b = c2_Omega;
  c2_o_y = c2_n_a * c2_p_b;
  c2_q_b = c2_U2;
  c2_p_y = 30.666666666666668 * c2_q_b;
  c2_Roll_ddot = (c2_m_y + c2_o_y) + c2_p_y;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 78);
  c2_o_a = c2_Roll_dot;
  c2_r_b = c2_Yaw_dot;
  c2_q_y = c2_o_a * c2_r_b;
  c2_p_a = c2_q_y;
  c2_r_y = c2_p_a * 0.7333333333333335;
  c2_q_a = c2_Roll_dot;
  c2_s_y = c2_q_a * 0.0086666666666666663;
  c2_r_a = c2_s_y;
  c2_s_b = c2_Omega;
  c2_t_y = c2_r_a * c2_s_b;
  c2_t_b = c2_U3;
  c2_u_y = 30.666666666666668 * c2_t_b;
  c2_Pitch_ddot = (c2_r_y - c2_t_y) + c2_u_y;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 79);
  c2_s_a = c2_Pitch_dot;
  c2_u_b = c2_Roll_dot;
  c2_v_y = c2_s_a * c2_u_b;
  c2_t_a = c2_v_y;
  c2_w_y = c2_t_a * 0.0;
  c2_v_b = c2_U4;
  c2_x_y = 17.69230769230769 * c2_v_b;
  c2_Yaw_ddot = c2_w_y + c2_x_y;
  ...
  *c2_inData)
{
  ...
  chartInstance = (SFc2_QuadsimInstanceStruct *)chartInstanceVoid;
  c2_mxArrayOutData = NULL;
  for (c2_i10 = 0; c2_i10 < 17; c2_i10++) {
    c2_b_inData[c2_i10] = (*(real_T (*)[17])c2_inData)[c2_i10];
  }
  ...
  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_create("y", c2_u, 0, 0U, 1U, 0U, 2, 1, 17), FALSE);
  sf_mex_assign(&c2_mxArrayOutData, c2_y, FALSE);
  return c2_mxArrayOutData;
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1034122159U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3409749611U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1960532285U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(628806854U);
}
...
mxArray *sf_c2_Quadsim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("IWULFQYO8Xpfp7N6c6jzc");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,2026);
...
static void mdlSetWorkWidths_c2_Quadsim(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3763034025U));
  ssSetChecksum1(S,(2512447863U));
  ssSetChecksum2(S,(1014537292U));
  ssSetChecksum3(S,(83294537U));
