#ifndef __c5_quadPD_h__
#define __c5_quadPD_h__
...
#ifndef typedef_SFc5_quadPDInstanceStruct
#define typedef_SFc5_quadPDInstanceStruct
...
typedef struct {
  ...
  uint8_T c5_is_active_c5_quadPD;
} SFc5_quadPDInstanceStruct;

#endif                                 /*typedef_SFc5_quadPDInstanceStruct*/
...
extern void c5_quadPD_method_dispatcher(SimStruct *S, int_T method, void *data);
