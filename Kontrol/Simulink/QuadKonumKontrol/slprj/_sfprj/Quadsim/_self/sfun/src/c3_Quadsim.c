...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(272292464U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4033433216U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(505224583U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(93917177U);
}
...
mxArray *sf_c3_Quadsim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("Qo1lUeSpKprNHI4qB57WtF");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,731);
...
static void mdlSetWorkWidths_c3_Quadsim(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2256119933U));
  ssSetChecksum1(S,(1063615711U));
  ssSetChecksum2(S,(1126131634U));
  ssSetChecksum3(S,(596236766U));
