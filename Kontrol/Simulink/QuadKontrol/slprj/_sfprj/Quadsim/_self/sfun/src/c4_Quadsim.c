...
static const char * c4_debug_family_names[13] = { "arm_l", "craft_m", "b", "d",
...
static void c4_chartstep_c4_Quadsim(SFc4_QuadsimInstanceStruct *chartInstance);
static void initSimStructsc4_Quadsim(SFc4_QuadsimInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static void c4_emlrt_marshallIn(SFc4_QuadsimInstanceStruct *chartInstance, const
  mxArray *c4_out, const char_T *c4_identifier, real_T c4_y[4]);
static void c4_b_emlrt_marshallIn(SFc4_QuadsimInstanceStruct *chartInstance,
...
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_c_emlrt_marshallIn(SFc4_QuadsimInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static void c4_d_emlrt_marshallIn(SFc4_QuadsimInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[4]);
...
static void c4_eml_scalar_eg(SFc4_QuadsimInstanceStruct *chartInstance);
static void c4_eml_error(SFc4_QuadsimInstanceStruct *chartInstance);
static const mxArray *c4_e_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_e_emlrt_marshallIn(SFc4_QuadsimInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_f_emlrt_marshallIn(SFc4_QuadsimInstanceStruct *chartInstance,
  const mxArray *c4_b_is_active_c4_Quadsim, const char_T *c4_identifier);
static uint8_T c4_g_emlrt_marshallIn(SFc4_QuadsimInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
  ...
  const mxArray *c4_st)
{
  ...
  for (c4_i1 = 0; c4_i1 < 4; c4_i1++) {
    (*c4_out)[c4_i1] = c4_dv0[c4_i1];
  }

  chartInstance->c4_is_active_c4_Quadsim = c4_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c4_u, 1)), "is_active_c4_Quadsim");
  sf_mex_destroy(&c4_u);
...
static void sf_c4_Quadsim(SFc4_QuadsimInstanceStruct *chartInstance)
{
  ...
  real_T (*c4_in)[4];
  c4_out = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 1);
  c4_in = (real_T (*)[4])ssGetInputPortSignal(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 3U, chartInstance->c4_sfEvent);
  for (c4_i2 = 0; c4_i2 < 4; c4_i2++) {
    _SFD_DATA_RANGE_CHECK((*c4_in)[c4_i2], 0U);
  }

  for (c4_i3 = 0; c4_i3 < 4; c4_i3++) {
    _SFD_DATA_RANGE_CHECK((*c4_out)[c4_i3], 1U);
  }

  chartInstance->c4_sfEvent = CALL_EVENT;
  c4_chartstep_c4_Quadsim(chartInstance);
...
static void c4_chartstep_c4_Quadsim(SFc4_QuadsimInstanceStruct *chartInstance)
{
  ...
  int32_T c4_i5;
  int32_T c4_i6;
  static real_T c4_a[16] = { 7987.2204472843459, 7987.2204472843459,
  ...
  real_T (*c4_b_out)[4];
  real_T (*c4_b_in)[4];
  c4_b_out = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 1);
  c4_b_in = (real_T (*)[4])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 3U, chartInstance->c4_sfEvent);
  for (c4_i4 = 0; c4_i4 < 4; c4_i4++) {
    c4_in[c4_i4] = (*c4_b_in)[c4_i4];
  }

  sf_debug_symbol_scope_push_eml(0U, 13U, 13U, c4_debug_family_names,
    c4_debug_family_var_map);
  sf_debug_symbol_scope_add_eml(&c4_arm_l, 0U, c4_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c4_craft_m, 1U, c4_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c4_b, 2U, c4_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c4_d, 3U, c4_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c4_g, 4U, c4_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(c4_U, 5U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(c4_MM, 6U, c4_d_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(c4_MA, 7U, c4_b_sf_marshallOut,
    c4_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c4_Omd, 8U, c4_b_sf_marshallOut,
    c4_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c4_nargin, 9U, c4_c_sf_marshallOut,
    c4_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c4_nargout, 10U, c4_c_sf_marshallOut,
    c4_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(c4_in, 11U, c4_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(c4_out, 12U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c4_i10 = 0; c4_i10 < 4; c4_i10++) {
    c4_C[c4_i10] = c4_MA[c4_i10];
  }

  for (c4_i11 = 0; c4_i11 < 4; c4_i11++) {
    c4_MA[c4_i11] = c4_C[c4_i11];
  }

  for (c4_i12 = 0; c4_i12 < 4; c4_i12++) {
    c4_C[c4_i12] = c4_MA[c4_i12];
  }

  for (c4_i13 = 0; c4_i13 < 4; c4_i13++) {
    c4_MA[c4_i13] = c4_C[c4_i13];
  }
  ...
  for (c4_i14 = 0; c4_i14 < 4; c4_i14++) {
    ...
    for (c4_i16 = 0; c4_i16 < 4; c4_i16++) {
      c4_MA[c4_i14] += c4_a[c4_i15 + c4_i14] * c4_b_b[c4_i16];
      c4_i15 += 4;
    }
  }
  ...
  for (c4_i17 = 0; c4_i17 < 4; c4_i17++) {
    c4_b_b[c4_i17] = c4_MA[c4_i17];
  }

  for (c4_k = 0; c4_k < 4; c4_k++) {
    c4_b_k = 1.0 + (real_T)c4_k;
    c4_x = c4_b_b[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      c4_b_k), 1, 4, 1, 0) - 1];
    c4_y = muDoubleScalarAbs(c4_x);
    c4_C[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("", c4_b_k),
      1, 4, 1, 0) - 1] = c4_y;
  }

  for (c4_i18 = 0; c4_i18 < 4; c4_i18++) {
    c4_Omd[c4_i18] = c4_C[c4_i18];
  }

  for (c4_c_k = 0; c4_c_k < 4; c4_c_k++) {
    c4_d_k = 1.0 + (real_T)c4_c_k;
    if (c4_Omd[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
          c4_d_k), 1, 4, 1, 0) - 1] < 0.0) {
      c4_eml_error(chartInstance);
    }
  }

  for (c4_e_k = 0; c4_e_k < 4; c4_e_k++) {
    c4_d_k = 1.0 + (real_T)c4_e_k;
    c4_b_x = c4_Omd[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
      "", c4_d_k), 1, 4, 1, 0) - 1];
    c4_c_x = c4_b_x;
    c4_c_x = muDoubleScalarSqrt(c4_c_x);
    c4_Omd[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      c4_d_k), 1, 4, 1, 0) - 1] = c4_c_x;
  }
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  for (c4_i21 = 0; c4_i21 < 4; c4_i21++) {
    c4_b_inData[c4_i21] = (*(real_T (*)[4])c4_inData)[c4_i21];
  }
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  SFc4_QuadsimInstanceStruct *chartInstance;
  chartInstance = (SFc4_QuadsimInstanceStruct *)chartInstanceVoid;
  c4_out = sf_mex_dup(c4_mxArrayInData);
  ...
  for (c4_i24 = 0; c4_i24 < 4; c4_i24++) {
    (*(real_T (*)[4])c4_outData)[c4_i24] = c4_y[c4_i24];
  }
  ...
  *c4_inData)
{
  ...
  for (c4_i25 = 0; c4_i25 < 4; c4_i25++) {
    c4_b_inData[c4_i25] = (*(real_T (*)[4])c4_inData)[c4_i25];
  }
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  SFc4_QuadsimInstanceStruct *chartInstance;
  chartInstance = (SFc4_QuadsimInstanceStruct *)chartInstanceVoid;
  c4_Omd = sf_mex_dup(c4_mxArrayInData);
  c4_identifier = c4_varName;
  c4_thisId.fIdentifier = c4_identifier;
  c4_thisId.fParent = NULL;
  c4_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_Omd), &c4_thisId, c4_y);
  sf_mex_destroy(&c4_Omd);
  for (c4_i28 = 0; c4_i28 < 4; c4_i28++) {
    (*(real_T (*)[4])c4_outData)[c4_i28] = c4_y[c4_i28];
  }
...
static void c4_info_helper(c4_ResolvedFunctionInfo c4_info[23])
{
  ...
  c4_info[0].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c4_info[0].fileTimeLo = 1286815242U;
  c4_info[0].fileTimeHi = 0U;
  c4_info[0].mFileTimeLo = 0U;
  c4_info[0].mFileTimeHi = 0U;
  c4_info[1].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c4_info[1].name = "power";
  c4_info[1].dominantType = "double";
  c4_info[1].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c4_info[1].fileTimeLo = 1336518496U;
  ...
  c4_info[8].fileTimeLo = 1286815244U;
  c4_info[8].fileTimeHi = 0U;
  c4_info[8].mFileTimeLo = 0U;
  c4_info[8].mFileTimeHi = 0U;
  c4_info[9].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c4_info[9].name = "eml_div";
  c4_info[9].dominantType = "double";
  c4_info[9].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m";
  c4_info[9].fileTimeLo = 1313344210U;
  ...
  c4_info[10].fileTimeLo = 1323166978U;
  ...
  c4_info[11].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m";
  c4_info[11].fileTimeLo = 1286815196U;
  ...
  c4_info[14].fileTimeLo = 1289516092U;
  ...
  c4_info[15].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  c4_info[15].fileTimeLo = 1323166978U;
  ...
  c4_info[16].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m";
  c4_info[16].fileTimeLo = 1286815196U;
  ...
  c4_info[17].fileTimeLo = 1299073174U;
  ...
  c4_info[18].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c4_info[18].fileTimeLo = 1286815094U;
  c4_info[18].fileTimeHi = 0U;
  c4_info[18].mFileTimeLo = 0U;
  c4_info[18].mFileTimeHi = 0U;
  c4_info[19].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c4_info[19].name = "eml_scalar_abs";
  c4_info[19].dominantType = "double";
  c4_info[19].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_abs.m";
  c4_info[19].fileTimeLo = 1286815112U;
  c4_info[19].fileTimeHi = 0U;
  c4_info[19].mFileTimeLo = 0U;
  c4_info[19].mFileTimeHi = 0U;
  c4_info[20].context = "";
  c4_info[20].name = "sqrt";
  c4_info[20].dominantType = "double";
  c4_info[20].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sqrt.m";
  c4_info[20].fileTimeLo = 1286815152U;
  c4_info[20].fileTimeHi = 0U;
  c4_info[20].mFileTimeLo = 0U;
  c4_info[20].mFileTimeHi = 0U;
  c4_info[21].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sqrt.m";
  c4_info[21].name = "eml_error";
  c4_info[21].dominantType = "char";
  c4_info[21].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_error.m";
  c4_info[21].fileTimeLo = 1305314400U;
  c4_info[21].fileTimeHi = 0U;
  c4_info[21].mFileTimeLo = 0U;
  c4_info[21].mFileTimeHi = 0U;
  c4_info[22].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sqrt.m";
  c4_info[22].name = "eml_scalar_sqrt";
  c4_info[22].dominantType = "double";
  c4_info[22].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_sqrt.m";
  c4_info[22].fileTimeLo = 1286815138U;
...
static void c4_eml_error(SFc4_QuadsimInstanceStruct *chartInstance)
{
  ...
  char_T c4_u[30];
  const mxArray *c4_y = NULL;
  for (c4_i36 = 0; c4_i36 < 30; c4_i36++) {
    c4_u[c4_i36] = c4_varargin_1[c4_i36];
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3243935161U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3537593949U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1458634847U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2110583096U);
}
...
mxArray *sf_c4_Quadsim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("aMnji2QuEs1ad6Rku5JBUC");
...
static const mxArray *sf_get_sim_state_info_c4_Quadsim(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"out\",},{M[8],M[0],T\"is_active_c4_Quadsim\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(1U, *c4_out);
        }
      }
    } else {
...
static void mdlSetWorkWidths_c4_Quadsim(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(4149263535U));
  ssSetChecksum1(S,(72492371U));
  ssSetChecksum2(S,(1008245022U));
  ssSetChecksum3(S,(3523694456U));
