...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4104308979U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1824944720U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(738335680U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(186277025U);
}
...
mxArray *sf_c2_Quadsim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("2JBLF0k3mzfmBi6ytTd5AC");
...
static void mdlSetWorkWidths_c2_Quadsim(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(569914078U));
  ssSetChecksum1(S,(2985967652U));
  ssSetChecksum2(S,(1013587064U));
  ssSetChecksum3(S,(310235241U));
