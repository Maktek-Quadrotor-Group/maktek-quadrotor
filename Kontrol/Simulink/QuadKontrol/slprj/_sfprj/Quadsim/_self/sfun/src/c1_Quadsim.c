...
static const char * c1_debug_family_names[31] = { "roll_set", "pitch_set",
  ...
  "yaw_i", "yaw_d", "roll_error", "pitch_error", "yaw_error", "roll_d_error",
  "pitch_d_error", "yaw_d_error", "roll_return", "pitch_return", "yaw_return",
  "nargin", "nargout", "Cin", "Cout" };
...
static void c1_emlrt_marshallIn(SFc1_QuadsimInstanceStruct *chartInstance, const
  mxArray *c1_Cout, const char_T *c1_identifier, real_T c1_y[3]);
static void c1_b_emlrt_marshallIn(SFc1_QuadsimInstanceStruct *chartInstance,
...
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_c_emlrt_marshallIn(SFc1_QuadsimInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_d_emlrt_marshallIn(SFc1_QuadsimInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_e_emlrt_marshallIn(SFc1_QuadsimInstanceStruct *chartInstance,
  ...
  *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_Quadsim;
  ...
  const mxArray *c1_st)
{
  ...
  c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 0)), "Cout",
                      c1_dv0);
  for (c1_i1 = 0; c1_i1 < 3; c1_i1++) {
    (*c1_Cout)[c1_i1] = c1_dv0[c1_i1];
  }

  chartInstance->c1_is_active_c1_Quadsim = c1_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 1)), "is_active_c1_Quadsim");
  sf_mex_destroy(&c1_u);
...
static void c1_chartstep_c1_Quadsim(SFc1_QuadsimInstanceStruct *chartInstance)
{
  ...
  sf_debug_symbol_scope_add_eml_importable(&c1_roll_set, 0U, c1_c_sf_marshallOut,
    c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_pitch_set, 1U,
    c1_c_sf_marshallOut, c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_yaw_set, 2U, c1_c_sf_marshallOut,
    c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_roll_dot, 3U, c1_c_sf_marshallOut,
    c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_pitch_dot, 4U,
    c1_c_sf_marshallOut, c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_yaw_dot, 5U, c1_c_sf_marshallOut,
    c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_roll, 6U, c1_c_sf_marshallOut,
    c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_pitch, 7U, c1_c_sf_marshallOut,
    c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_yaw, 8U, c1_c_sf_marshallOut,
    c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c1_roll_p, 9U, c1_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c1_roll_i, 10U, c1_c_sf_marshallOut,
    c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c1_roll_d, 11U, c1_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_pitch_p, 12U, c1_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c1_pitch_i, 13U, c1_c_sf_marshallOut,
    c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c1_pitch_d, 14U, c1_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_yaw_p, 15U, c1_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c1_yaw_i, 16U, c1_c_sf_marshallOut,
    c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c1_yaw_d, 17U, c1_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c1_roll_error, 18U,
    c1_c_sf_marshallOut, c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_pitch_error, 19U,
    c1_c_sf_marshallOut, c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_yaw_error, 20U,
    c1_c_sf_marshallOut, c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_roll_d_error, 21U,
    c1_c_sf_marshallOut, c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_pitch_d_error, 22U,
    c1_c_sf_marshallOut, c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_yaw_d_error, 23U,
    c1_c_sf_marshallOut, c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_roll_return, 24U,
    c1_c_sf_marshallOut, c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_pitch_return, 25U,
    c1_c_sf_marshallOut, c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_yaw_return, 26U,
    c1_c_sf_marshallOut, c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_nargin, 27U, c1_c_sf_marshallOut,
    c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_nargout, 28U, c1_c_sf_marshallOut,
    c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(c1_Cin, 29U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(c1_Cout, 30U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  mxArray *c1_Cout, const char_T *c1_identifier, real_T c1_y[3])
{
  ...
  c1_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_Cout), &c1_thisId, c1_y);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(453769946U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2036101438U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2073283129U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(394656287U);
}
...
mxArray *sf_c1_Quadsim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("8Ef2rP9rNmN8EYjgzhWsxE");
...
static const mxArray *sf_get_sim_state_info_c1_Quadsim(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Cout\",},{M[8],M[0],T\"is_active_c1_Quadsim\",}}"
  };
...
static void mdlSetWorkWidths_c1_Quadsim(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3024287447U));
  ssSetChecksum1(S,(183770591U));
  ssSetChecksum2(S,(42810244U));
  ssSetChecksum3(S,(1655126009U));
