...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2325257088U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2880279643U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2956444586U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(428280373U);
}
...
mxArray *sf_c4_Quadsim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("xS3cwmei0iu6iOpXHO7rDH");
...
static void mdlSetWorkWidths_c4_Quadsim(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2674173064U));
  ssSetChecksum1(S,(4124064646U));
  ssSetChecksum2(S,(735754728U));
  ssSetChecksum3(S,(3951510359U));
