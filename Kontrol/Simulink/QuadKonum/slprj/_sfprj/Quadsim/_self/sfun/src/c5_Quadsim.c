...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2892567838U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3053105053U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3185793831U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2794979085U);
}
...
mxArray *sf_c5_Quadsim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("dGflvlZRZzuo19kzpbum7E");
...
static void mdlSetWorkWidths_c5_Quadsim(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2548457037U));
  ssSetChecksum1(S,(1544999882U));
  ssSetChecksum2(S,(696945515U));
  ssSetChecksum3(S,(1325218460U));
